...
import {IdentityResponse} from 'src/shared/type'
import {DataStorageService} from './data-storage.service'
import {DataStoragePageableRequest, DataStoragePageableResponse, DataStorageView} from '../dto/data-storage.view'
...
export class DataStorageResolver {
  ...
  async find(
    @Args('request', {type: () => DataStoragePageableRequest}) {take, skip, search}: DataStoragePageableRequest,
